...
if("TRUE" STREQUAL "TRUE")
  set(multi_map_server_SOURCE_PREFIX /home/zawubuntu/code/my_code/src/Fast-Planner/uav_simulator/Utils/multi_map_server)
...
if(NOT "/home/zawubuntu/code/my_code/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zawubuntu/code/my_code/src/Fast-Planner/uav_simulator/Utils/multi_map_server/${idir}'.  ${_report}")
    endif()
